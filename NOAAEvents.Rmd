...
```{r healthplot, fig.height = 5, fig.width=10}
...
```{r ecoplot, fig.height = 5, fig.width=10}
# Multiplot using ggplot2 and gridExtra
...
These results are interesting as we can assume they are weighted by the sample population, since humans and crops are concentrated in different areas of the US.
